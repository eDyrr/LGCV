...
// getBeginningOfDay give a time.Time calculates the start of that day
...
// printDayCol prints the day number (0 is Sunday) prints the day name,
...
// fillCommits given a repo found in `path`, gets the commits and
